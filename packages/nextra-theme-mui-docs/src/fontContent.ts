// We'll manually inline the content of https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&display=swap
// as Next.js doesn't know how to apply font optimizations from external modules and also only
// understands elements created with the _jsx pragma
// See https://github.com/vercel/next.js/blob/afa86cc5bbd488d123e2c5888205a40a5a0afe42/packages/next/build/webpack/plugins/font-stylesheet-gathering-plugin.ts#L67
export default `
/* cyrillic-ext */
@font-face {
  font-family: 'Roboto';
