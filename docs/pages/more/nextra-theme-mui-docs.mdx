...
1. Install peer dependencies `yarn add next react react-dom nextra @material-ui/core@next @material-ui/icons@next`.
...
export default {
  ...
  title: 'App created with nextra and  nextra-theme-mui-docs.',
};
```

4. Create your first page `pages/index.mdx`
